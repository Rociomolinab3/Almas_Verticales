...
export default function TravelDetail() {
  ...
  return (
    <div className="relative bg-grisOscuro2 min-h-screen w-full ">
      {/* Imagen de fondo */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen py-32 px-10">
        <h2 className={`${montserrat200.className} text-2xl text-grisMedio mb-10`}>
          ...
          {dataDetail.map((stage, index) => (
            ...
            >
              <button
                ...
                onClick={() =>
                  setActiveStage(activeStage === stage.number ? null : stage.number)
                }
              >
