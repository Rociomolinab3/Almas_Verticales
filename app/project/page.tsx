...
import Mountain from '@/assets/images/fondoMontgris.png';
  ...
  return (
    <div>
      ...
      <div className="relative bg-grisOscuro2 min-h-[100vh] w-full">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden block md:hidden"> {/* Mostrar solo en pantallas pequeñas */}
          <Image
            src={Mountain}
            alt="Fondo Montaña"
            layout="fill"
        ...
        {/* Imagen de fondo para pantallas medianas y grandes */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden hidden md:block"> {/* Mostrar solo en pantallas medianas y grandes */}
          <Image
            src={Mapa}
            alt="Mapa América"
            layout="fill"
