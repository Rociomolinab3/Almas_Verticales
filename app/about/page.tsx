...
export default function About() {
  return (
    ...
    <section className="pt-10 pb-20 flex flex-row bg-grisMedioClaro gap-4">
       <div className="w-[50%] p-[5%] ">
       <div className="bg-azulOscuro w-[40%] text-white py-2 px-4 rounded-lg hover:bg-azulMedio transition duration-300">
            ¡Seguí nuestro viaje!
      </div>
                ...
                <div id="informativo" className="flex flex-row pt-10">
                   ...
                   <p className="text-grisOscuro text-md flex flex-wrap">Brindamos datos seguros y específicos para que vos también seas protagonista de los trekkings que realizamos</p>
                   </div>
                </div>
                <div id="motivadores" className="flex flex-row pt-10">
                   ...
                   <p className="text-grisOscuro text-md flex flex-wrap">Te ayudamos a obtener las herramientas necesarias para que logres cumplir tus objetivos.</p>
                   </div>
                </div>
                <div id="apasionados" className="flex flex-row pt-10">
                   ...
                   <p className="text-grisOscuro text-md flex flex-wrap">Amamos las montañas y estamos yendo detrás de nuestro sueño. Te animamos a que también lo hagas.</p>
                   </div>
                </div>
                </div>
       </div>
       <div className="w-[50%] flex flex-col">
        <div className="flex flex-row h-[60%] w-[90%] items-end px-8 gap-4 py-2">
        <Image
