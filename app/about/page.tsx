          ...
          <div className="w-full lg:w-1/2 pl-0 lg:pl-4 mt-4 lg:mt-0">
            ...
            <div className="text-grisClaro">
              ...
              <p className="mb-4">
                ...
                Unir Ushuaia con Alaska subiendo al punto más alto de América.
                Mostrándoles no sólo las cumbres, sino la cultura y diversidad de
                cada montaña. Queremos compartir con ustedes nuestro país. ¿Nos
                acompañas?
              </p>
            </div>
          </div>
        ...
        <div className="w-[90%] flex flex-col items-center justify-center xl:w-[50%] p-[5%] xl:items-start">
          ...
          <div>
            <div id="informativo" className="flex flex-row justify-center pt-10 xl:justify-start">
              <div className="w-[15%] mr-4"> {/* Ajuste de separación */}
